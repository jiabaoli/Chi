...
- VFX "ULTIMATE" PARTICLE PACK (v2.5.0):
...
- GPU PARTICLES! Simulated and rendered entirely on the GPU.

-- Extremely fast, and able to mimic Shuriken on a basic level.
-- Randomization, forces, colour over lifetime, etc, etc...

-- GPU PARTICLES NOT YET INCLUDED WITH ASSET... It's too, "alpha" right now.
