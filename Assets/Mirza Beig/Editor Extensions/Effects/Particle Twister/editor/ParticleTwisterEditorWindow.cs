    ...
    namespace EditorExtensions
    {
        ...
        namespace Effects
        {
            ...
            public class ParticleTwisterEditorWindow : EditorWindow
            {
                ...
                {
                    ParticleTwisterEditorWindow window =
                        EditorWindow.GetWindow<ParticleTwisterEditorWindow>(false, "Mirza Beig - Particle Twister");
                ...
                public static EditorWindow getEditorWindow(string name)
                {
                    ...
                    return EditorWindow.GetWindow(assembly.GetType(name));
                }
